    ...
    <div className="container marketing">
      ...
      <div className="row">
        <div className="col-lg-4">
          ...
          <Link legacyBehavior href="{% url 'ajuda' %}"><p><a className="btn btn-secondary" role="button">Mais detalhes »</a></p></Link>
        </div>
        {/* <!-- /.col-lg-4 --> */}
        <div className="col-lg-4">
          ...
          <Link legacyBehavior href="{% url 'resgate' %}"><p><a className="btn btn-secondary"  role="button">Mais detalhes »</a></p></Link>
        </div>
        {/* <!-- /.col-lg-4 --> */}
        <div className="col-lg-4">
          ...
          <Link legacyBehavior href="{% url 'contatos' %}"><p><a className="btn btn-secondary"  role="button">Mais detalhes »</a></p></Link>
        </div>
        {/* <!-- /.col-lg-4 --> */}
      </div>
      {/* <!-- /.row --> */}
