                  ...
                  <div className="card mt-2 shadow" key={dado.nome_evento}>
                    ...
                    <div className="card-body">
                      <div className="row justify-content-start">
                        ...
                        <div className="m-1">
                          <a className="btn btn-secondary" href="https://www.google.com.br/maps/place/{{ evento.local_evento }}" role="button" target="_blank">Como chegar</a>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="card-body">
                      <div className="row justify-content-start">
                        ...
                        <div className="row justify-content-start">
                          ...
                          <div className="col fs-6">
                            <p className="card-text fs-6"> . <a href="https://www.google.com.br/maps/place/{ evento.local_evento }" target="_blank">Como chegar</a></p>
                          </div>
                        </div>
                        <div className="row">
                          <div className="col-1 fs-6">
